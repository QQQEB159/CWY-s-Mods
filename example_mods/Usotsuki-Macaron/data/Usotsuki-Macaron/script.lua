...
function onStepHit()
	...
	if curStep == 195 or curStep == 595 or curStep == 940 then
		...
		doTweenX('borderScaleX', 'border.scale', 2, 1, "quadOut");
		doTweenY('borderScaleY', 'border.scale', 2, 1, "quadOut");
		doTweenX('borderPosX', 'border', borderInitX, 1, "quadOut");
		doTweenY('borderPosY', 'border', borderInitY, 1, "quadOut");
	...
	if curStep == 131 or curStep == 532 or curStep == 896 then
		...
		doTweenX('borderScaleX', 'border.scale', 1, 1, "quadOut");
		doTweenY('borderScaleY', 'border.scale', 1, 1, "quadOut");
		doTweenX('borderPosX', 'border', -640, 1, "quadOut");
		doTweenY('borderPosY', 'border', -360, 1, "quadOut");
